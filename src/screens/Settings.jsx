  ...
  return (
    <div style={{ maxWidth:680, margin:'0 auto' }}>
      ...
      <div style={{ background:'#fff', borderRadius:14, border:'1px solid #E8ECF0', overflow:'hidden' }}>
        ...
        {tab === 'jobs' && <>
          <div style={{ padding:'14px 18px', borderBottom:'1px solid #F3F4F6' }}>
            <div style={{ fontSize:11, fontWeight:700, color:'#9CA3AF', textTransform:'uppercase', letterSpacing:'.06em' }}>Statuses</div>
          </div>
          <NavRow icon={<><path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h11"/></>}
            iconBg="#EEF2FF" iconColor="#5B8AF0"
            label="Job statuses"
            sub="Customise the statuses available on jobs"
            to="/settings/job-statuses" />
          <NavRow icon={<><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/></>}
            iconBg="#F5F3FF" iconColor="#8B5CF6"
            label="Room statuses"
            sub="Track progress of individual rooms within a job"
            to="/settings/room-statuses" />
          <div style={{ padding:'14px 18px', borderBottom:'1px solid #F3F4F6', borderTop:'1px solid #F3F4F6' }}>
