  ...
  return (
    <div>
      <div style={{ background:'#fff', borderRadius:14, border:'1px solid #E8ECF0', overflow:'hidden' }}>
        ...
        <Row icon={<><path d="M18 20V10"/><path d="M12 20V4"/><path d="M6 20v-6"/></>}                        iconBg="#FFF7ED" iconColor="#F97316" label="Appliances"         sub="Manage appliance categories and fields"   to="/settings/appliances" />
        ...
        <Row icon={<><rect x="9" y="9" width="13" height="13" rx="2"/><path d="M5 15H4a2 2 0 01-2-2V4a2 2 0 012-2h9a2 2 0 012 2v1"/></>} iconBg="#FFF7ED" iconColor="#C2410C" label="Copy format" sub="Configure order description copy template" to="/settings/copy-format" />
